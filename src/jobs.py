...
def correct_subtype(string):
    stringset = set(['expediente_digitalizado_en_origen',
    'acta_de_resultados_de_legitimacion',
    'contrato_colectivo_de_trabajo', 'constancia_de_legitimacion',
    'acuerdo_de_deposito', 'contrato_colectivo_de_trabajo',
    'ultima_revision_de_contrato', 'ultima_revision_salarial',
    'acuerdo_de_ultima_revision_de_contrato',
    'acuerdo_de_ultima_revision_salarial',
    'acuerdode_convenio_modificatorio', 'convenio_modificatorio',
    'acuerdo_de_deposito_ante_la_jca', 'convenio_de_revision_salarial',
    'resolucion_final_del_tramite', 'tabulador_de_sueldos',
    'acuerdo_de_inicio_de_consulta',
    'resolucion_de_constancia_de_representatividad',
    'tabulador_de_sueldos_yo_salarios', 'resolucion_de_convocatoria',
